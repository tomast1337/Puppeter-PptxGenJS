...
type ColorValue = string | { color?: string; transparency?: number; type?: string };
...
export function normalizeColor(value?: ColorValue, fallback = "transparent"): string {
    ...
    return colorToCSS({ color: resolved, transparency: value.transparency });
}
...
export function normalizeLine(value?: PptxGenJS.ShapeLineProps): NormalizedLine {
    ...
    return {
        ...
        width: pointsToPixels(value.width ?? PPTX_DEFAULTS.shape.line.widthPt),
